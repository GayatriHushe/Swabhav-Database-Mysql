USE SWABHAV;
CREATE TABLE EMP1 ( EMPNO INT NOT NULL, ENAME VARCHAR(10), JOB VARCHAR(9), MGR INT REFERENCES EMP (EMPNO), HIREDATE VARCHAR(20), SAL INT, COMM  INT, DEPTNO INT NOT NULL);
